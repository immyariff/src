...
import { dateFormatOptions } from "../../utils/format/date/date";
...
export const printInvoice = (invoice: ReturnType<typeof createInvoice>) => {
  console.log(`Invoice ID: ${invoice.id}`);
  console.log(`Invoice Number: ${invoice.invoiceNumber}`);
  console.log(`Invoice Google Drive Link: ${invoice.googleDriveLink}`);
};
